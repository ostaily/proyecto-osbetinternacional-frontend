<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Contacto'"
      :tituloBoton="'Crear Contacto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Contacto'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
  ...
  import  formPaises from './components/formContacto.vue'
